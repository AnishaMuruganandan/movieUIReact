...
class MovieNavigationComponent extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    this.setState({
      movieNavigationDetails: nextProps.movieInfo
    });
  }
  handleLeftClick() {
  ...
  render() {
    return (
      <div className="movieList">
        ...
        <div className="movieListImages" id="movieList" ref={this.scroller}>
          {
            (this.items = this.state.movieNavigationDetails.map(
              (item, index) => (
                <div
